    ...
    definition(window.Player);
        ...
        function VrajPlayer(props) {
                ...
                __gestureHandler = {
                    ...
                    __directionHandler: {
                        left: function() {
                            ...
                            console.log("left", this.distance.x, ((this.distance.x * 100) / this.rootEl.clientWidth) + "%");
            ...
            function updatePlayerSource({ video, audio, thumb, subtitle }) {
                ...
                if (thumb) {
                    this.container.thumbnail = thumb;
                }
                if (audio) {
        ...
        function domInit(props) {
            ...
            props.audio && vrajPlayer.setAttribute("arc", props.audio);
